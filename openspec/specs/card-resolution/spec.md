# Card Resolution Specification

## Purpose
Resolving a list of bare card numbers into full card data from the local database, as JSON or Markdown, with optional deck-composition checks. Serves people and tools that hold a deck list but none of the card data, without granting them access to the API.
